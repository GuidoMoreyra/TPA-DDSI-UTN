  ...
  private void crearHechosDeEjemplo() {
    ...
    Object[][] hechos = {
        // Buenos Aires
        {
            ...
            "Manifestación pacífica de trabajadores en Plaza de Mayo. Miles de personas se reunieron para reclamar mejoras salariales y condiciones laborales.",
            "Protestas",
            -34.6083, -58.3712,
        ...
        },
        {
            ...
            "Fuertes lluvias causaron anegamientos en varias zonas de La Plata. Los vecinos reportan calles cortadas y problemas de drenaje.",
            "Desastres Naturales",
            -34.9205, -57.9536,
        ...
        },
        {
            ...
            "Gran convocatoria en el festival de música indie realizado en Parque Centenario con más de 10 bandas locales.",
            "Eventos Culturales",
            -34.6058, -58.4332,
            LocalDate.now().minusDays(1),
            LocalTime.of(18, 0),
            "https://www.youtube.com/watch?v=jNQXAC9IVRw"  // Video de ejemplo (Me at the zoo - primer video de YouTube)
        },

        // Córdoba
        {
            "Corte de ruta en Villa Carlos Paz",
            "Vecinos cortaron la ruta Provincial  en reclamo por el mal estado del camino. El tráfico estuvo interrumpido por 3 horas.",
            "Cortes de Ruta",
            -31.4135, -64.4978,
        ...
        },
        {
            ...
            "Se inauguró un nuevo centro cultural en barrio Güemes con talleres gratuitos para la comunidad.",
            "Eventos Culturales",
            -31.4073, -64.1852,
            LocalDate.now().minusDays(7),
            LocalTime.of(17, 30),
            "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800"  // Imagen de centro cultural
        },

        // Santa Fe
        {
            "Crecida del río Paraná",
            "El río Paraná alcanzó niveles de alerta en Rosario. Autoridades monitorean la situación constantemente.",
            "Desastres Naturales",
            -32.9442, -60.6505,
        ...
        // Mendoza
        {
            ...
            "Productores vitivinícolas protestaron frente a Casa de Gobierno por políticas impositivas.",
            "Protestas",
            -32.8908, -68.8272,
        ...
        },
        {
            ...
            "Se registró un sismo de 3.2 grados en la escala de Richter sin daños materiales ni personales.",
            "Desastres Naturales",
            -32.8833, -68.8167,
        ...
        },
        {
            ...
            "Choque múltiple en Avenida Mate de Luna durante hora pico. Tres vehículos involucrados, solo daños materiales.",
            "Accidentes",
            -26.8206, -65.2044,
            LocalDate.now().minusDays(1),
            LocalTime.of(19, 15),
        ...
        // Salta
        {
            ...
            "Miles de fieles participaron de la tradicional procesión del Señor y la Virgen del Milagro.",
            "Eventos Culturales",
            -24.7859, -65.4117,
        ...
        // Entre Ríos
        {
            ...
            "Turistas reportan avistamiento de carpinchos y aves autóctonas en el Parque Nacional El Palmar.",
            "Medio Ambiente",
            -31.8628, -58.2629,
