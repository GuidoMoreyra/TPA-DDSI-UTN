...
public class ServicioAgregacionTest implements SimplePersistenceTest {
  ...
  void setup() {
    ...
    when(repoTest.getHechos())
        .thenReturn(List.of(hechoTres, hechoDos, hechoUno, hechoCuatro, hechoCinco, hechoSeis));
    // Act
  ...
  @Test
  @DisplayName(
      "se utiliza como fuente principal un servicio de agregacion Para crear una coleccion")
