  ...
  public void setUp() {
    ...
    justificacion =
        "Este hecho contiene información completamente incorrecta y desactualizada que debe ser"
            ...
            + " para obtener información precisa y verificada. Es fundamental mantener la"
            + " integridad de nuestra base de datos eliminando este tipo de contenido que no cumple"
            + " con los estándares de calidad requeridos. Los administradores deben revisar"
            + " cuidadosamente esta solicitud y proceder con la eliminación del hecho lo antes"
            + " posible para evitar la propagación de información falsa o incorrecta.";
